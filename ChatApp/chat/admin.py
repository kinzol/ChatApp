...
class GroupAdmin(admin.ModelAdmin):
    list_display = ("id", 'root', 'name', 'get_html_photo', 'display_participants', 'display_admins', 'bio', 'time_create')
    list_display_links = ("id", 'root', 'name', 'get_html_photo', 'display_participants', 'display_admins', 'bio', 'time_create')
